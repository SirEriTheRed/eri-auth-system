...
Full API documentation generated by TypeDoc is available in the [`docs/`](_media/docs) directory.
...
###### This README was generated using a [coding agent](https://opencode.ai) and the [`README-template.md`](_media/README-template.md).
